import { success, request, failure, update, delAction, like} from '../actions/simple'
...
const useAsyncActions = () => {
	...
	const {getPosts, addPost: insertPost, deletePost, editPost, likePost: likeService} = useService()
